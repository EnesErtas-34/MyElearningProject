...
namespace MyElearningProject.Controllers
{
    public class InstructorCourseController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var courseToInstructorById = context.Courses.Where(x => x.InstructorID == instructorID).ToList();
            ViewBag.ınstructorCourseCount = context.Courses.Where(x => x.InstructorID == instructorID).Count();
